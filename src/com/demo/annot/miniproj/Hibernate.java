...
public class Hibernate<T> {
	...
	private AtomicInteger plId = new AtomicInteger(0);
	...
	public void save(T entity) throws Exception {
		...
		for (Entry<Field, Class<?>> en : columnNameTypeMap.entrySet()) {
			// check the PK
			en.getKey().setAccessible(true);
			Object val = en.getKey().get(entity);
			System.out.println("Name: " + en.getKey().getName() + " Val:" + en.getKey().get(entity));
