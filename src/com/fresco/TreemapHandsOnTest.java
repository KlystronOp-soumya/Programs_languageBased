...
public class TreemapHandsOnTest {
	...
	public boolean testCheck() {
		...
		exp.put(2, "Rohit");
		exp.put(4, "Pandya");
		TreeMap<Integer, String> actual = th
				.createPlayerPositionMap("3,Dhoni,100|1,Virat,50|5,Jadeja,90|2,Rohit,70|4,Pandya,30");
	...
	public boolean testCheck2() {
		...
		exp.put("Rohit", 70);
		exp.put("Pandya", 30);
		TreeMap<String, Integer> actual = th
				.createPlayerScoreMap("3,Dhoni,100|1,Virat,50|5,Jadeja,90|2,Rohit,70|4,Pandya,30");
	...
	public void testGetQuery1() {
		...
		if (testCheck()) {
			...
			String actual2 = th.getQuery("3,Dhoni,120|1,Virat,103|5,Jadeja,90|2,Rohit,70|4,Pandya,30|6,Rahul,150",
					"1 4 6");
			assertEquals(expected2, actual2);
		} else
			assertEquals(0, 1);
	...
	public void testGetQuery3() {
		...
		if (testCheck2()) {
			...
			String actual = th.getQuery("3,Dhoni,120|1,Virat,103|5,Jadeja,90|2,Rohit,70|4,Pandya,30|6,Rahul,150",
					"2 100");
			assertEquals(expected, actual);
		} else
			assertEquals(0, 1);
